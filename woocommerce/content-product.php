    ...
    <div class="card app_card">
        <div class="card_top position-relative">
            <img class="card-img-top app_card_image"
                 src="<?php echo get_the_post_thumbnail_url( get_the_ID(), 'medium' ); ?>" alt="PH"/>
            ...
            <div class="product_icons_wraper align-middle position-absolute">
                <div class="product_icons radius text-center d-flex align-items-center">
                    ...
                    <a href="#" class="wooscp-btn wooscp-btn-<?php echo get_the_ID() ?>"
        ...
        <div class="card-body">
            <h6 class="card-title text-center font-weight-bold" style="max-height: 36px;">
